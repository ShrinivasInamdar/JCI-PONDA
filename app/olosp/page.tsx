export default function OLOSPPage() {
  return (
    <div>
        ...
        One Local Organisation Sustainable Project
        </p>
      </div>
      ...
      <div className="container mx-auto px-4 py-16 text-center">
        ...
        <p className="text-lg text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
          We're currently working on this page. Please check back later for updates on our One Local Organisation Sustainable Project.
        </p>
      </div>
    </div>
  )
